...
const url = "https://api.themoviedb.org/3/movie/upcoming?api_key=307c7894a4a56f0cfac887e273a285b3&language=en-US&page="
const url2 = "region=TH"
          ...
          .then((result)=>{
              ...
              for(let i=0 ; i<round ; i++){
                  if(!result.results[i].adult){
                      console.log(result.results[i].adult);
